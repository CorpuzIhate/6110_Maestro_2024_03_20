...
public class SwerveDriveLLAutoCMD extends Command {
  ...
  public SwerveDriveLLAutoCMD(
          SwerveSub swerveSubsystem, LimeLightSub limeLightSub, double totalTime, double ySpeed, double turningSpeed) 
          { 
  ...
  public void execute() {
    ...
    xSpeed = limeLightSub.getLimelightDistancePIDOutput(((LimeLightConsants.kMaxShoot + LimeLightConsants.kMinShoot) / 2));
    ...
    chassisSpeeds = new ChassisSpeeds(xSpeed,-ySpeed, -turningSpeed); //hard coded -s, outputs the xspeeds of the limelight
